...
# ks = growth of bacteria?
# rB = respiration of bacteria?
# dB = death of bacteria?

 # t = time, state = current state variables
...
######## Example: "a 1-D model of oxygen dynamics in a river. #######
# "This model consists of two coupled partial differential equations, which are solved to steady-state."
