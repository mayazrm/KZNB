...
########
#Fix scaling of RT: it is in hundreths of ms; make it ms;
ranfacefo1$rtms <- ranfacefo1$RT*100
ranfacefo1$logRT <- log(ranfacefo1$RT*100)
...
summary(ranfacem1)
confint(ranfacem1)
#For computing population ranges: N=21, df=20, t_95 = 2.08
#Intercept range: 5.21 + 2.09*0.33 = 5.90; 5.21 - 2.09*0.33 = 4.52
#Slope     range:-0.20 + 2.09*0.11 = 0.03;-0.20 - 2.09*0.33 =-0.43
