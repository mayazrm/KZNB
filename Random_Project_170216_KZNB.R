...
# RANDOM PROJECT ANALYSES 170216 (Niall)
...
rndt <- subset(rnd, response.rt >= 0.1 & response.rt < 3.69) #Previous lower cutoff was 10 ms.
...
setwd("C:/Users/Niall/Dropbox/NIALL1/MET/Suppes Talk/Ran Hassin")
