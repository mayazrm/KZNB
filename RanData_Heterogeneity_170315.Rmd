...
hist(post.ran6mod2b$sd_subject_congr, breaks = 50, main = paste("Posterior Distribution of Valence Random Effect SD"), xlab="Valence Random Effect SD in Milliseconds", xlim = c(0, 30))
