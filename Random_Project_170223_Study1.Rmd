...
modindiv1 <- (lmer(rt ~ valenceE*prom.c*prev.c + trial40c + (1 + valenceE| id),  data=datamerge))
summary(modindiv1)
...
library(effects)
plot(effect(term="valenceE:prom.c",mod=modindiv1,default.levels=2),multiline=TRUE)
plot(effect(term="valenceE:prev.c",mod=modindiv1,default.levels=2),multiline=TRUE)
