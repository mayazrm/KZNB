...
ran7mod2math <- lmer(rt ~ congr*ptimer*math_anxiety.c + (1 + congr | subject), data = ran7m)
...
ran7mod2math2 <- lmer(rt ~ congr*ptimer*math_self_rating.c + (1 + congr | subject), data = ran7m)
