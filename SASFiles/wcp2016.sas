...
title 'Both time points';
title2 'Fixed effect of trait_vale, time, and their interaction';
title3 'Random trait valence effect (two variances and a covariance)';
proc mixed data=sesp2015.rtexpt covtest noclprint cl;
...
*Note: Problem estimating all covariances
title 'Both time points';
title2 'Fixed effect of trait_vale, time, and their interaction';
title3 'Random: main-effect trait valence, time, and covariances';
proc mixed data=sesp2015.rtexpt covtest noclprint cl;
class subj trait_vale time_e;
model rt_log = trait_vale time_e trait_vale*time_e/noint solution ddfm=kr;
random  trait_vale time_e/subject = subj type = un g gcorr;
